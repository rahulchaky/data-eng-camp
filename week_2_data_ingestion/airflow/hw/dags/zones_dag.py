...
URL_TEMPLATE = 'https://github.com/DataTalksClub/nyc-tlc-data/releases/download/misc/taxi_zone_lookup.csv'
...
GCP_PATH_TEMPLATE = 'raw/taxi_zone_lookup/taxi_zone_lookup.parquet'
...
with gcp_zones:
    ...
    unzip_task = BashOperator(
        task_id='unzip',
        # This file is not actually compressed so this should work?
        bash_command="mv /opt/airflow/taxi_zone_lookup.csv.gz /opt/airflow/taxi_zone_lookup.csv"
    )
