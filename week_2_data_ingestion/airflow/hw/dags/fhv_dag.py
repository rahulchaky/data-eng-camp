...
URL_TEMPLATE = URL_PREFIX + \
    '/fhv_tripdata_{{ execution_date.strftime(\'%Y-%m\') }}.csv.gz'
...
GCP_PATH_TEMPLATE = 'raw/fhv_tripdata/{{ execution_date.strftime(\'%Y\') }}/fhv_tripdata_{{ execution_date.strftime(\'%Y-%m\') }}.parquet'
